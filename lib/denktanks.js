...
export const DENKTANK_SOURCES = [
  ...
  { name: 'EUISS', url: 'https://www.iss.europa.eu/rss', color: '#003399' },

  // SCP — Sociaal en Cultureel Planbureau
  { name: 'SCP', url: 'https://www.scp.nl/rss', color: '#6E3F8E' },

  // SIPRI — Stockholm International Peace Research Institute
  { name: 'SIPRI', url: 'https://www.sipri.org/rss.xml', color: '#005B8E' },

  // Bruegel — Europees economisch beleidsonderzoek (Brussel)
  { name: 'Bruegel', url: 'https://www.bruegel.org/rss.xml', color: '#E8A000' },

  // Chatham House — Royal Institute of International Affairs (Londen)
  { name: 'Chatham House', url: 'https://www.chathamhouse.org/rss.xml', color: '#002147' },

  // ECFR — European Council on Foreign Relations
  { name: 'ECFR', url: 'https://ecfr.eu/feed/', color: '#1D3557' },
];
