...
export const RECOMMENDATIONS = [
  {
    title: 'Microsoft dicht kritiek lek (CVSS 10.0) in AI-platform Azure AI Foundry',
    link: 'https://thehackernews.com/2026/09/microsoft-patches-cvss-100-azure-ai.html',
    source: 'The Hacker News',
    summary: 'Microsoft verhielp een kwetsbaarheid met de hoogst mogelijke score (10.0) in Azure AI Foundry, het bedrijfsplatform om generatieve AI-apps en agents te bouwen. Door een ontbrekende authenticatiecontrole kon een aanvaller zonder inloggegevens via het netwerk hogere rechten krijgen. Het lek is volgens Microsoft server-side al volledig verholpen; misbruik is niet vastgesteld.',
    why: 'Laat zien hoe de haast rond AI-platformen ook nieuwe, ernstige beveiligingsrisico\'s meebrengt.',
    pubDate: '2026-09-17T12:00:00Z',
    added: '2026-09-22T15:17:00Z',
  },
  {
